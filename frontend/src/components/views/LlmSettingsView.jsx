...
import {
  Settings, Plus, Trash2, Check, AlertCircle,
  Loader2, ChevronLeft, Server, Key, Cpu, Thermometer
} from 'lucide-react';
import { settingsApi } from '../../services/api';

/**
 * LlmSettingsView - LLM 配置页面
 *
 * 支持配置最多5个LLM服务端点，可以切换激活的配置
 */
const LlmSettingsView = ({ onBack }) => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col h-full bg-zinc-950 text-zinc-100 items-center justify-center">
  ...
  return (
    <div className="flex flex-col h-full bg-zinc-950 text-zinc-100 overflow-hidden">
      {/* Header */}
      <div className="px-8 py-6 border-b border-zinc-800 flex items-center gap-4 bg-zinc-900/20">
        <button
          onClick={onBack}
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-bold text-white flex items-center gap-3">
            ...
            {t('settings.llmTitle') || 'LLM Configuration'}
          </h1>
